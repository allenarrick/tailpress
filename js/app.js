...
${expression ? 'Expression: "' + expression + '"\n\n' : ""}`, el);
  ...
  function src_default2(Alpine2) {
    Alpine2.directive("collapse", (el, { expression, modifiers }, { effect: effect2, evaluateLater: evaluateLater2 }) => {
  ...
  var require_focus_trap = __commonJS2((exports) => {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
  ...
  var import_focus_trap = __toModule2(require_focus_trap());
  var import_tabbable = __toModule2(require_dist());
  function src_default5(Alpine2) {
    ...
    Alpine2.directive("trap", Alpine2.skipDuringClone((el, { expression, modifiers }, { effect: effect2, evaluateLater: evaluateLater2, cleanup }) => {
